      ...
      <section className="py-16 sm:py-20 bg-gradient-section">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 sm:mb-16 animate-fade-in">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 sm:mb-6 text-primary">For Patients</h1>
      ...
      <section className="py-16 sm:py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <div className="flex flex-col sm:flex-row items-center justify-center mb-4 sm:mb-6">
            <Shield className="w-12 h-12 sm:w-16 sm:h-16 text-accent mb-3 sm:mb-0 sm:mr-4" />
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold">24/7 Emergency Services</h2>
          </div>
